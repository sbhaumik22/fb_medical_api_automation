...
import static stepDefinitions.MediaApiClient.getUserMediaLink;

public class DeleteAccStepDefinition extends BaseStepDefinition {
    ...
    public void the_user_sets_the_header_with_a_valid_bearer_token_for_deletion(String auth) {
        reqDeleteSpec = given().header(auth, "Bearer " +  AuthTokenContext.getToken()).spec(getRequestSpecification());
    }
